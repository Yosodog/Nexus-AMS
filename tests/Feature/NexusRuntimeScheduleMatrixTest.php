...
class NexusRuntimeScheduleMatrixTest extends TestCase
{
    private const STANDALONE_EVENTS = [
        ...
        'raids:process-profiles --limit=1000@* * * * *',
        'raids:project-profiles@7 * * * *',
        'raids:refresh-alliance-profiles@10 3 * * *',
        'raids:calibrate@40 3 * * 1',
        'raids:prune-loot-events@5 4 * * *',
        'pw:health-check@* * * * *',
        ...
        'App\\Jobs\\RefreshBankBalanceSnapshots@5 * * * *',
        ...
        'App\\Jobs\\EvaluateResourceShortfallAlertsJob@*/10 * * * *',
        'App\\Jobs\\DispatchScheduledAlertBatchesJob@* * * * *',
        'App\\Jobs\\RollupAlertMetricsJob@20 0 * * *',
        'App\\Jobs\\PruneAlertHistoryJob@20 1 * * *',
        ...
        'raids:expire-claims@* * * * *',
        'raids:prune-finder-impressions@20 4 * * *',
