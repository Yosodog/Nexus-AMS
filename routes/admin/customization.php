...
Route::prefix('customization')
    ...
    ->group(function () {
        ...
        Route::get('/pages/create', [CustomizationController::class, 'create'])->name('admin.customization.create');
        Route::post('/pages', [CustomizationController::class, 'store'])->name('admin.customization.store');
        ...
        Route::post('/pages/{page}/unpublish', [CustomizationController::class, 'unpublish'])->name('admin.customization.unpublish');
