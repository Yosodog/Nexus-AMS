            ...
            <div class="navbar-start min-w-0 gap-1">
                <div class="dropdown">
                    ...
                    @if ($showMemberNavigation)
                        <ul tabindex="0"
                            class="menu menu-sm dropdown-content bg-base-100 rounded-box z-[60] mt-3 w-52 p-2 shadow">
            ...
            <div class="navbar-end shrink-0 gap-1 sm:gap-2">
                ...
                @else
                    <div class="dropdown dropdown-end sm:hidden">
                        ...
                        <ul tabindex="0"
                            class="menu menu-sm dropdown-content bg-base-100 rounded-box z-[60] mt-3 w-44 p-2 shadow">
