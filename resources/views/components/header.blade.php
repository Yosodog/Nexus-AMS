            ...
            <div class="navbar-end">
                ...
                <div class="dropdown dropdown-end">
                    <div tabindex="0" role="button" class="btn btn-ghost btn-circle">
                        <!-- Sun Icon -->
                        <svg class="theme-icon-sun h-10 w-10 fill-current" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24">
                            <path
                        ...
                        <!-- Moon Icon -->
                        <svg class="theme-icon-moon h-10 w-10 fill-current hidden" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24">
                            <path
