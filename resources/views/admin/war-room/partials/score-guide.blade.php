...
<div class="card shadow-sm h-100">
    <div class="card-header">
        ...
        <small class="text-base-content/50">Quick reference for planners reviewing assignments.</small>
    </div>
    <div class="card-body">
        ...
        <div class="small">
            ...
            <p class="text-base-content/50 mb-0">Relative power blends city count, nation score, and estimated military strength; low parity caps the total match regardless of other bonuses.</p>
        </div>
    </div>
</div>
