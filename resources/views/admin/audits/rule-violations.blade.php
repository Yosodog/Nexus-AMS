        ...
        <div class="w-full">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <p class="text-base-content/50 mb-0">Live offenders for this rule. Rows clear automatically when targets comply.</p>
                </div>
                <div class="col-auto flex gap-2">
                    <a href="{{ route('admin.audits.rules.edit', $rule) }}" class="btn btn-outline-primary">
                        <i class="o-pencil me-1"></i>Edit rule
                    </a>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            <div class="flex flex-wrap gap-3 align-items-center">
                ...
                <span class="text-base-content/50 small">Expression: <code class="font-monospace">{{ $rule->expression }}</code></span>
            </div>
        </div>
                ...
                @forelse($violations as $violation)
                    <tr>
                                ...
                                <div class="font-semibold">
                                    <a href="https://politicsandwar.com/nation/id={{ $violation->nation?->id }}"
                                       ...
                                       class="text-decoration-none">
                                        ...
                                        <span class="text-base-content/50">({{ $violation->nation?->nation_name ?? 'Unknown nation' }})</span>
                                    </a>
                                </div>
                        ...
                        <td>
                            ...
                            <div class="text-base-content/50 small">{{ $violation->first_detected_at->toDayDateTimeString() }}</div>
                        </td>
                        <td>
                            <div class="font-semibold">{{ $violation->last_evaluated_at->diffForHumans() }}</div>
                            <div class="text-base-content/50 small">{{ $violation->last_evaluated_at->toDayDateTimeString() }}</div>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="3" class="text-center text-base-content/50 py-4">No current violations for this rule.</td>
                    </tr>
                @endforelse
                </tbody>
            </table>
