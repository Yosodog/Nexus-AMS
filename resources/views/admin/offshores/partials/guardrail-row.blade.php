...
<div class="guardrail-row grid gap-3 rounded-box border border-base-300 p-3 md:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_auto] md:items-end">
    <label class="block space-y-2">
        ...
        <select class="select w-full" name="guardrails[{{ $index }}][resource]" required>
    ...
    <button type="button" class="btn btn-outline btn-error btn-sm md:self-end" data-action="remove-guardrail" aria-label="Remove {{ ucfirst($resourceValue) }} guardrail">
