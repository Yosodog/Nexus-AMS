<header class="admin-topbar">
    <div class="admin-topbar__inner">
        <label for="admin-sidebar" class="btn btn-ghost btn-circle btn-sm nexus-icon-button tooltip lg:hidden" aria-label="Open administrative navigation" data-tip="Open administrative navigation">
