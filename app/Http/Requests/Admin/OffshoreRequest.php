    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'direct_deposit_tax_id' => [
                ...
                'integer',
                'min:1',
                'required_with:direct_deposit_fallback_tax_id',
                'different:growth_circles_tax_id',
            ],
            'direct_deposit_fallback_tax_id' => [
                'nullable',
                'integer',
                'min:1',
                'required_with:direct_deposit_tax_id',
            ],
            'growth_circles_tax_id' => [
                'nullable',
                'integer',
                'min:1',
                'required_with:growth_circles_fallback_tax_id',
            ...
            'growth_circles_fallback_tax_id' => [
                ...
                'integer',
                'min:1',
                'required_with:growth_circles_tax_id',
            ],
