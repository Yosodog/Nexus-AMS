...
final class CityEconomicsCalculator
{
    ...
    private const PROJECT_EFFECT_NOTES = [
        ...
        'bureau_of_domestic_affairs' => 'Adds its income synergy only when Open Markets is selected.',
        ...
        'government_support_agency' => 'Adds its income synergy only when Open Markets is selected.',
    ...
    private function modifiers(array $nationInput, array $projects, array $buildings, array $metrics): array
    {
        ...
        $modifiers = [
            ...
            [
                ...
                'label' => 'Government Support Agency income synergy',
                'rate' => 0.005,
            ...
            [
                ...
                'label' => 'Bureau of Domestic Affairs income synergy',
                'rate' => 0.0025,
